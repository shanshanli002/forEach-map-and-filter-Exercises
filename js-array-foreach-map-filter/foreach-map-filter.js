...
function showFirstAndLast(arr){
    ...
    return arr.map(function(element,i,array){
...
function vowelCount(str){
   ...
   let u = 0;
    ...
    wordArray.forEach(function(element,index,array){
        if (element === 'a'){
           a++;
           vowelCountObject['a']=a;
        } else if (element === 'e'){
            e++;
            vowelCountObject['e']=e;
        } else if (element === 'i'){
            i++;
             vowelCountObject['i']=i;
        } else if (element === 'o'){
            o++;
            vowelCountObject['o']=o;
        } else if (element === 'u'){
            u++;
            vowelCountObject['u']=u;
        } else {
        }
   }); 
...
function filterByValue(arr, key) {
    return arr.filter(function(element,i,array){
...
function find(arr, searchValue) {
  let newArray = arr.filter(function(element,i,array){
...
function removeVowels(str) {
    ...
    let arrayNoVowels = newArray.filter(function(element,i,array){
...
function doubleOddNumbers(arr) {
    ...
    return oddArray.map(function(element){
        return element*2;
    });
